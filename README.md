...
Macros used with Microsoft Word to add new functionalities to Mendeley's plugin. Now, Widi Rahman has added support for Mendeley page number format to hyperlinks generator functionalities in this script (IEE only).
